        ...
        <div class="section-inner shadow-sm rounded">
            ...
            <div class="content">
                ...
                <div class="skillset">
                    ...
                    <div class="item">
                        <h3 class="level-title">PHP, Codeigniter &amp; Laravel<span class="level-label" data-bs-toggle="tooltip" data-bs-placement="left" title="You can use the tooltip to explain more about your skill level..."><i class="fas fa-info-circle"></i>Pro</span></h3>
                    ...
                    <div class="item">
                        <h3 class="level-title">React &amp; Redux<span class="level-label" data-bs-toggle="tooltip" data-placement="left" title="You can use the tooltip to explain more about your skill level..."><i class="fas fa-info-circle"></i>Expert</span></h3>
                        <div class="level-bar progress">
                    ...
                    <p><a rel="noreferrer" class="more-link" href="https://github.com/Aikalmine"><i class="fas fa-external-link-alt"></i>More on GitHub</a></p> 
                </div>              
            </div>
        </div>   
    </aside>
